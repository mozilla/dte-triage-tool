...
def test_kanban_filter_handle_error(search_data, page, local_instance: str, locators: Locators):
...
def test_project_search_and_filter(input_search_params, search_data, page, local_instance: str, locators: Locators):
