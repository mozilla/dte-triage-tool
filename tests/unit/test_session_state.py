class TestSessionState:
    def test_form_values_set_get_has_clear(self, session_state):
        ...
        assert session_state.has_form_values()
    ...
    def test_priorities_set_get_has_clear(self, session_state):
        assert not session_state.get_priorities()
        ...
        assert session_state.has_priorities()
    ...
    def test_initial_board_set_get_has_clear(self, session_state):
        assert not session_state.get_initial_board()
        ...
        assert session_state.has_initial_board()
    ...
    def test_status_map_set_get_has_clear(self, session_state):
        assert not session_state.get_status_map()
        ...
        assert session_state.has_status_map()
